...
RidgePlot(OPC_Oligo, features = c("SOX2","YAP1","PDGFRA","OLIG1","OLIG2","SOX10","BCAS1","TCF7L2","MYRF","PLP1","RBFOX1", "CNP"), stack = T, fill.by = "ident") + scale_y_discrete(limits=rev(c("Fetal COP", "OPC", "COP","Early Oligo", "Oligo"))) + scale_fill_manual(values = c("OPC" = "#0096FF", "Fetal COP" = "#00FFFF", "COP" = "#A7C7E7","Early Oligo" = "#3998f5","Oligo" = "#1F51FF"))
```
